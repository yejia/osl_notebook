...
class Invitation_CodeAdmin(MultiDBModelAdmin):
     list_display = ('code', 'group', 'max_size', 'current_size', 'expire_date', 'init_date')


class User_Reg_Invitation_CodeAdmin(MultiDBModelAdmin):

...
urlpatterns = patterns('',
    ...
    (r'/linkNotes/$','notebook.notes.views.link_notes'),    
    (r'^linkagenotes/$','notebook.notes.views.linkagenotes'),
    (r'^linkagenotes/note/(?P<note_id>[^/]+)/$','notebook.notes.views.linkagenote'),
    (r'/updateLinkageNoteInline/$','notebook.notes.views.update_linkage_note_inline'),
    (r'/deleteLinkage/$','notebook.notes.views.delete_linkage'),
    (r'/deleteNoteFromLinkage/$','notebook.notes.views.delete_note_from_linkage'),    

...
class Snippet(Note):
    ...
    attachment = models.FileField(upload_to=get_storage_loc, max_length=1000, blank=True, storage=fs, verbose_name=ugettext_lazy('Attachment'),) #TODO:validate the file for security reason    
